...
import com.jinjerkeihi.nfcfelica.ui.HiddenSpan;
...
public abstract class Trip implements Parcelable {
    ...
    private String mTypeTrip;
    private String mTripIdMd5;
    ...
    public String getTripIdMd5() {
        return mTripIdMd5;
    }

    public void setTripIdMd5(String tripIdMd5) {
        this.mTripIdMd5 = tripIdMd5;
    }
}
