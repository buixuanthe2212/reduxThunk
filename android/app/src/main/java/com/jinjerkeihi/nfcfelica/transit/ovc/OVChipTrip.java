...
public class OVChipTrip extends Trip {
    ...
    public static final Parcelable.Creator<OVChipTrip> CREATOR = new Parcelable.Creator<OVChipTrip>() {
...
//        mSame = (parcel.readInt() == 1);
    ...
    private static Station getStation(int companyCode, int stationCode) {
        try {
            SQLiteDatabase db = MainApplication.getInstance().getOVChipDBUtil().openDatabase();
