 ...
 */
package com.jinjerkeihi.nfcfelica.transit.hsl;
...
import com.jinjerkeihi.nfcfelica.card.desfire.files.DesfireRecord;
import com.jinjerkeihi.nfcfelica.transit.CompatTrip;


public class HSLTrip extends CompatTrip {
    public static final Parcelable.Creator<HSLTrip> CREATOR = new Parcelable.Creator<HSLTrip>() {
    ...
    public String getAgencyName() {
        ...
        @SuppressLint("StringFormatMatches") String pax = app.getString(R.string.hsl_person_format, mPax);
        if (mArvo == 1) {
            @SuppressLint("StringFormatMatches") String mins = app.getString(R.string.hsl_mins_format, ((this.mExpireTimestamp - this.mTimestamp) / 60));
