...
import static com.jinjerkeihi.nfcfelica.transit.lax_tap.LaxTapData.METRO_BUS_ROUTES;
...
public class LaxTapTrip extends NextfareTrip {
    ...
    public static final Parcelable.Creator<LaxTapTrip> CREATOR = new Parcelable.Creator<LaxTapTrip>() {
