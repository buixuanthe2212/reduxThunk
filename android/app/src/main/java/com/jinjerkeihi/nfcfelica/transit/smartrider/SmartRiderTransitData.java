 ...
 */
package com.jinjerkeihi.nfcfelica.transit.smartrider;
...
public class SmartRiderTransitData extends TransitData {
    ...
    public static final Parcelable.Creator<SmartRiderTransitData> CREATOR = new Parcelable.Creator<SmartRiderTransitData>() {
        @Override
