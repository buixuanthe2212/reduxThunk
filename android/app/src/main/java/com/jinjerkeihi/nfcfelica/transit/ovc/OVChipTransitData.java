...
import com.jinjerkeihi.nfcfelica.util.ImmutableMapBuilder;
...
public class OVChipTransitData extends TransitData {
    ...
    public static final Parcelable.Creator<OVChipTransitData> CREATOR = new Parcelable.Creator<OVChipTransitData>() {
    ...
    public static String getAgencyName(int agency) {
        ...
        return MainApplication.getInstance().getString(R.string.unknown_format, "0x" + Long.toString(agency, 16));
    }
