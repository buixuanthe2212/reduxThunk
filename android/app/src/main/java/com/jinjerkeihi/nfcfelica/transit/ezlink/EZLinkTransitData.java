...
package com.jinjerkeihi.nfcfelica.transit.ezlink;
...
import com.jinjerkeihi.nfcfelica.card.cepas.CEPASTransaction;
...
public class EZLinkTransitData extends TransitData {
    public static final Parcelable.Creator<EZLinkTransitData> CREATOR = new Parcelable.Creator<EZLinkTransitData>() {
